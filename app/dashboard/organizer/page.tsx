...
import { User, Calendar, Ticket, Settings, Plus, Users, DollarSign, Clock } from "lucide-react"
              ...
              <CardContent>
                <div className="space-y-4">
                  ...
                  >
                    ...
                    <p className="text-white/70">Start a new event</p>
                  </Link>
                  <Link 
                    href="/events/manage"
                    className="block p-4 rounded-lg bg-white/5 hover:bg-white/10 transition-colors"
                  >
                    ...
                    <p className="text-white/70">View and edit your events</p>
                  </Link>
                  <Link 
                    href="/profile"
                    className="block p-4 rounded-lg bg-white/5 hover:bg-white/10 transition-colors"
              ...
              <CardContent>
                <div className="space-y-4">
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="p-4 rounded-lg bg-white/5">
                      <p className="text-white/70">Total Attendees</p>
                      <h3 className="text-2xl font-bold text-blue-400">{user.totalAttendees || 0}</h3>
                    </div>
                    <div className="p-4 rounded-lg bg-white/5">
              ...
              <CardContent>
                <div className="space-y-6">
                  ...
                  <div className="p-4 rounded-lg bg-white/5">
                    ...
                    <p className="text-white/70">Total Events: {user.totalEvents || 0}</p>
                    <p className="text-white/70">Total Attendees: {user.totalAttendees || 0}</p>
                    <p className="text-white/70">Total Revenue: ${user.revenue?.toLocaleString() || 0}</p>
                  </div>
                </div>
              </CardContent>
            </Card>
